...
public class Prototype9SlotScript : MonoBehaviour 
{
	...
	void SpawnIcon()
	{
		...
		iconTransform.z = 0;//set to zero to ensure the icon will appear on top of the slot
		iconChooser = Random.Range (0, 5);
		switch(iconChooser)
		{
		case 0:
