...
public class InventoryItemDatabase 
{
	...
	public void Serialize()
	{
		...
		data.items.Add(new Shield(30,"Prefabs/Shield1Prefab", ItemType.Shield,3,"Weak Shield","BigShield",5,true));
		...
		data.items.Add(new Shield(50,"Prefabs/Shield1Prefab",ItemType.Shield,8,"Metal Shield","BigShield",9,true));
